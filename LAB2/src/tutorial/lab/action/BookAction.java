...
import tutorial.lab.dao.AuthorDAO;
import tutorial.lab.dao.BookDAO;
...
public class BookAction extends ActionSupport
{
	...
	if (newAuthor != null)
	{
		...
		newAuthor.setAuthorID(newBook.getAuthorID());
	 ...
	 if(modify == false && authorDAO.isAuthorIDExist(newBook.getAuthorID())==false)
	 {
	    session = ActionContext.getContext().getApplication();
